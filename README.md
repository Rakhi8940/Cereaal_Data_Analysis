<p align="center"> <img src="https://github.com/user-attachments/assets/f617928b-f700-4264-b1f2-3c9d0022bbe4" width="900" alt="Cereal Rating Analysis Banner" style="margin: 12px 0; border-radius: 18px; background: #fff; box-shadow: 0 4px 16px rgba(0,0,0,0.12); padding: 0;"> </p>
...
<p align="center" /> <img width="350" height="300" alt="image" src="https://via.placeholder.com/350x300?text=Rating+vs+Cereal+Type" />
🔥 Correlation Heatmap
<p align="center" /> <img width="350" height="300" alt="image" src="https://via.placeholder.com/350x300?text=Correlation+Heatmap" />
📊 Pairplot Analysis
<p align="center" /> <img width="350" height="300" alt="image" src="https://via.placeholder.com/350x300?text=Pairplot+Analysis" />
📉 Calories vs Rating Trend
<p align="center" /> <img width="350" height="300" alt="image" src="https://via.placeholder.com/350x300?text=Calories+vs+Rating" />
📊 Shelf vs Calories Heatmap
<p align="center" /> <img width="350" height="300" alt="image" src="https://via.placeholder.com/350x300?text=Shelf+vs+Calories" />
